...
class RecoveryAction:
    """Represents a recovery action with a specific strategy."""
    ...
    def can_attempt(self) -> bool:
        ...
        cooldown_elapsed = (datetime.now() - self.last_attempt).total_seconds()
...
class ComponentMetrics:
    ...
    error_history: deque[str] = field(default_factory=lambda: deque(maxlen=10))
...
if TYPE_CHECKING:
    ...
    try:
        ...
        class _DummySignal:
            ...
            def __get__(self, instance: Any, owner: Any) -> "_DummySignal":
        ...
        class QTimer:  # type: ignore
            ...
            @staticmethod
            def set_interval(*_: Any, **__: Any) -> None:
...
def signal(*_args: Any, **_kwargs: Any) -> Any:  # type: ignore
    ...
    try:
        ...
        # Return a dummy class when Qt is not available
        class _DummySignal:
            """Dummy signal class that provides no-op emit and connect methods when Qt is not available."""
